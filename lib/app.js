...
var _splodingsocks$elm_add_import$Import$toString = function (import_) {
	var sortedSymbols = A2(_elm_lang$core$Maybe$map, _elm_lang$core$List$sort, import_.symbols);
	return A2(
		_elm_lang$core$Basics_ops['++'],
		'import ',
		A2(
			...
			A2(
				...
				A2(
					...
					A2(
						_elm_lang$core$Maybe$map,
						function (alias_) {
							return A2(_elm_lang$core$Basics_ops['++'], ' as ', alias_);
						},
						import_.alias)),
				A2(
					_elm_lang$core$Maybe$withDefault,
					...
					A2(
						...
						function (symbols) {
							return A2(
								...
								A2(
									_elm_lang$core$Basics_ops['++'],
									A2(_elm_lang$core$String$join, ', ', symbols),
									')'));
						},
						sortedSymbols)))));
};
var _splodingsocks$elm_add_import$Import$Import = F3(
	function (a, b, c) {
		return {moduleName: a, alias: b, symbols: c};
	});

var _splodingsocks$elm_add_import$Module$toString = function (module_) {
	var sortedImports = A2(
	...
	return A2(
		...
		A2(
			...
			A2(
				_elm_lang$core$String$join,
				'\n',
				A2(_elm_lang$core$List$map, _splodingsocks$elm_add_import$Import$toString, sortedImports)),
			A2(_elm_lang$core$Basics_ops['++'], '\n\n', module_.after)));
};
var _splodingsocks$elm_add_import$Module$Module = F3(
	function (a, b, c) {
		return {before: a, imports: b, after: c};
	});

var _splodingsocks$elm_add_import$Parser$everythingElse = _Bogdanp$elm_combine$Combine$regex('[^]*');
var _splodingsocks$elm_add_import$Parser$everythingBeforeImports = _Bogdanp$elm_combine$Combine$regex('[^]*?(?=import)');
var _splodingsocks$elm_add_import$Parser$anythingFollowedByNewlineWhitespaceOrEOL = _Bogdanp$elm_combine$Combine$regex('.*?(?=\n|\\s|$)');
var _splodingsocks$elm_add_import$Parser$nonWhitespace = _Bogdanp$elm_combine$Combine$while(
	F2(
		function (x, y) {
			return !_elm_lang$core$Native_Utils.eq(x, y);
		})(
		_elm_lang$core$Native_Utils.chr(' ')));
var _splodingsocks$elm_add_import$Parser$eol = _Bogdanp$elm_combine$Combine$regex('(\n|$)');
var _splodingsocks$elm_add_import$Parser$whitespace = _Bogdanp$elm_combine$Combine$while(
	F2(
		function (x, y) {
			return _elm_lang$core$Native_Utils.eq(x, y);
		})(
		_elm_lang$core$Native_Utils.chr(' ')));
var _splodingsocks$elm_add_import$Parser$moduleName = A2(
	_Bogdanp$elm_combine$Combine_ops['<*'],
	A2(
		_Bogdanp$elm_combine$Combine_ops['*>'],
		A2(
			_Bogdanp$elm_combine$Combine_ops['*>'],
			_Bogdanp$elm_combine$Combine$string('import'),
			_splodingsocks$elm_add_import$Parser$whitespace),
		_splodingsocks$elm_add_import$Parser$anythingFollowedByNewlineWhitespaceOrEOL),
	_Bogdanp$elm_combine$Combine$regex('(\\s*|\n|$)'));
var _splodingsocks$elm_add_import$Parser$alias = _Bogdanp$elm_combine$Combine$maybe(
	A2(
		_Bogdanp$elm_combine$Combine_ops['<*'],
		A2(
			_Bogdanp$elm_combine$Combine_ops['*>'],
			A2(
				_Bogdanp$elm_combine$Combine_ops['*>'],
				_Bogdanp$elm_combine$Combine$string('as'),
				_splodingsocks$elm_add_import$Parser$whitespace),
			_splodingsocks$elm_add_import$Parser$anythingFollowedByNewlineWhitespaceOrEOL),
		_Bogdanp$elm_combine$Combine$regex('(\\s*|\n|$)')));
var _splodingsocks$elm_add_import$Parser$symbols = _Bogdanp$elm_combine$Combine$maybe(
	A2(
		_Bogdanp$elm_combine$Combine$map,
		A2(
		...
		A2(
			...
			A2(
				...
				A2(
					_Bogdanp$elm_combine$Combine_ops['*>'],
					_splodingsocks$elm_add_import$Parser$whitespace,
					_Bogdanp$elm_combine$Combine$string('exposing (')),
				_Bogdanp$elm_combine$Combine$regex('.*(?=\\)\\s*(\n|$))')),
			_Bogdanp$elm_combine$Combine$regex('\\)\\s*(\n|$)'))));
var _splodingsocks$elm_add_import$Parser$import_ = A2(
	_Bogdanp$elm_combine$Combine_ops['<*>'],
	A2(
		_Bogdanp$elm_combine$Combine_ops['<*>'],
		A2(
			_Bogdanp$elm_combine$Combine_ops['<*>'],
			_Bogdanp$elm_combine$Combine$succeed(_splodingsocks$elm_add_import$Import$Import),
			_splodingsocks$elm_add_import$Parser$moduleName),
		_splodingsocks$elm_add_import$Parser$alias),
	_splodingsocks$elm_add_import$Parser$symbols);
var _splodingsocks$elm_add_import$Parser$imports = _Bogdanp$elm_combine$Combine$many(_splodingsocks$elm_add_import$Parser$import_);
var _splodingsocks$elm_add_import$Parser$module_ = A2(
	_Bogdanp$elm_combine$Combine_ops['<*>'],
	A2(
		_Bogdanp$elm_combine$Combine_ops['<*>'],
		A2(
			_Bogdanp$elm_combine$Combine_ops['<*>'],
			_Bogdanp$elm_combine$Combine$succeed(_splodingsocks$elm_add_import$Module$Module),
			_splodingsocks$elm_add_import$Parser$everythingBeforeImports),
		_splodingsocks$elm_add_import$Parser$imports),
	_splodingsocks$elm_add_import$Parser$everythingElse);
var _splodingsocks$elm_add_import$Parser$parseModule = function (inputSrc) {
	return A2(
		...
		A2(
			...
			A2(_Bogdanp$elm_combine$Combine$parse, _splodingsocks$elm_add_import$Parser$module_, inputSrc)));
};

var _splodingsocks$elm_add_import$AddImport$addImport = F3(
	function (moduleName, mabSymbol, inputSrc) {
		return A2(
			_elm_lang$core$Result$map,
			function (module_) {
				var newSymbol = A2(
					...
					mabSymbol);
				var importsByName = A2(
					_elm_lang$core$List$map,
					function (_p0) {
						var _p1 = _p0;
						return {ctor: '_Tuple2', _0: _p1.moduleName, _1: _p1};
					},
					module_.imports);
				var importsDict = _elm_lang$core$Dict$fromList(importsByName);
				var newImport = function () {
					var _p2 = A2(_elm_lang$core$Dict$get, moduleName, importsDict);
					if (_p2.ctor === 'Just') {
						var _p3 = _p2._0;
						return _elm_lang$core$Native_Utils.update(
							_p3,
							{
								symbols: A2(
									_elm_lang$core$Maybe$map,
									function (symbol) {
										var existingSymbols = A2(
											_elm_lang$core$Maybe$withDefault,
											{ctor: '[]'},
											_p3.symbols);
										return A2(_elm_lang$core$List$append, existingSymbols, symbol);
									},
									newSymbol)
							});
					} else {
						return {moduleName: moduleName, symbols: newSymbol, alias: _elm_lang$core$Maybe$Nothing};
					}
				}();
				var updatedDict = A3(_elm_lang$core$Dict$insert, moduleName, newImport, importsDict);
				return _splodingsocks$elm_add_import$Module$toString(
					_elm_lang$core$Native_Utils.update(
						module_,
						{
							imports: _elm_lang$core$Dict$values(updatedDict)
						}));
			},
			_splodingsocks$elm_add_import$Parser$parseModule(inputSrc));
	});

var _user$project$Main$init = A2(
	_elm_lang$core$Platform_Cmd_ops['!'],
	{input: '', moduleName: '', symbolName: _elm_lang$core$Maybe$Nothing, editorContents: '', error: ''},
	{ctor: '[]'});
var _user$project$Main$baseStyle = {ctor: '[]'};
var _user$project$Main$labelStyle = {
	ctor: '::',
	...
	_1: {
		...
		_1: {
			...
			_1: {
				...
				_1: {
					ctor: '::',
					_0: {ctor: '_Tuple2', _0: 'border-bottom', _1: '1px solid white'},
					_1: {
						ctor: '::',
						_0: {ctor: '_Tuple2', _0: 'font-size', _1: '1.2em'},
						_1: {ctor: '[]'}
...
var _user$project$Main$open = _elm_lang$core$Native_Platform.incomingPort('open', _elm_lang$core$Json_Decode$string);
var _user$project$Main$importAdded = _elm_lang$core$Native_Platform.outgoingPort(
	'importAdded',
	function (v) {
		return v;
	});
var _user$project$Main$Model = F5(
	function (a, b, c, d, e) {
		return {input: a, moduleName: b, symbolName: c, editorContents: d, error: e};
	});
		...
		switch (_p0.ctor) {
			case 'Open':
				return A2(
					...
					_elm_lang$core$Native_Utils.update(
						model,
						{editorContents: _p0._0}),
					{
						ctor: '::',
						_0: A2(
							_elm_lang$core$Task$attempt,
							_elm_lang$core$Basics$always(_user$project$Main$NoOp),
							_elm_lang$dom$Dom$focus('AddImportInput')),
						_1: {ctor: '[]'}
					});
			case 'NoOp':
				return A2(
			...
			case 'ChangeInput':
							...
							if (_p2._1.ctor === '[]') {
								...
								if (_p2._1._1.ctor === '[]') {
									...
									return {
										ctor: '_Tuple2',
										_0: _p2._0,
										_1: _elm_lang$core$Native_Utils.eq(_p3, '') ? _elm_lang$core$Maybe$Nothing : _elm_lang$core$Maybe$Just(_p3)
									};
								} else {
									break _v1_2;
								}
				...
				return A2(
					...
					_elm_lang$core$Native_Utils.update(
						model,
						{input: _p4, moduleName: fst, symbolName: snd}),
					{ctor: '[]'});
			default:
				var result = A3(_splodingsocks$elm_add_import$AddImport$addImport, model.moduleName, model.symbolName, model.editorContents);
				var _p5 = result;
				if (_p5.ctor === 'Ok') {
					var _p6 = _user$project$Main$init;
					var initMdl = _p6._0;
					return A2(
						_elm_lang$core$Platform_Cmd_ops['!'],
						initMdl,
						{
							ctor: '::',
							_0: _user$project$Main$importAdded(_p5._0),
							_1: {ctor: '[]'}
						});
				} else {
					return A2(
...
var _user$project$Main$view = function (model) {
	return A2(
		...
		{
			ctor: '::',
			_0: _elm_lang$html$Html_Attributes$style(_user$project$Main$baseStyle),
			_1: {ctor: '[]'}
		},
		{
			ctor: '::',
			_0: A2(
				...
				{
					ctor: '::',
					_0: _elm_lang$html$Html_Attributes$style(_user$project$Main$labelStyle),
					_1: {ctor: '[]'}
				},
				{
					ctor: '::',
					_0: _elm_lang$html$Html$text('Module name and optional symbol separated by a space'),
					_1: {
						ctor: '::',
						_0: A2(
							_elm_lang$html$Html$input,
							{
								...
								_1: {
									...
									_1: {
										ctor: '::',
										_0: _elm_lang$html$Html_Attributes$id('AddImportInput'),
										_1: {
											ctor: '::',
											_0: _elm_lang$html$Html_Events$onInput(_user$project$Main$ChangeInput),
											_1: {
												ctor: '::',
												_0: _elm_community$html_extra$Html_Events_Extra$onEnter(_user$project$Main$GO),
												_1: {
													ctor: '::',
				...
				_0: A2(
					_elm_lang$html$Html$div,
					{
						...
						_0: _elm_lang$html$Html_Attributes$style(
							{
								ctor: '::',
								_0: {ctor: '_Tuple2', _0: 'padding', _1: '0.75rem 1rem'},
								_1: {
									ctor: '::',
									_0: {ctor: '_Tuple2', _0: 'font-size', _1: '1.2rem'},
									_1: {ctor: '[]'}
								}
							}),
						_1: {ctor: '[]'}
						...
						_0: A2(
							...
							{ctor: '[]'},
							{
								...
								_0: _elm_lang$html$Html$text(
									A2(_elm_lang$core$Basics_ops['++'], 'Module name: ', model.moduleName)),
								_1: {ctor: '[]'}
							}),
						_1: {
							ctor: '::',
								...
								{ctor: '[]'},
								{
									...
									_0: _elm_lang$html$Html$text(
										A2(
											_elm_lang$core$Basics_ops['++'],
											'Symbol name: ',
											A2(_elm_lang$core$Maybe$withDefault, 'none', model.symbolName))),
									_1: {ctor: '[]'}
								}),
							_1: {
								ctor: '::',
...
var _user$project$Main$Open = function (a) {
...
var _user$project$Main$subscriptions = function (model) {
	return _elm_lang$core$Platform_Sub$batch(
		{
			ctor: '::',
			_0: _user$project$Main$open(_user$project$Main$Open),
			_1: {ctor: '[]'}
		});
};
